...
typedef uint32 ERemoteStorageFilePathType;
...
typedef uint32 EFloatingGamepadTextInputMode;
typedef uint32 ESteamIPType;
typedef uint32 ESteamIPv6ConnectivityState;
typedef uint32 ESteamIPv6ConnectivityProtocol;
...
typedef uint32 ERemoteStorageLocalFileChange;
typedef uint32 ESteamInputGlyphSize;
typedef uint32 EControllerHapticLocation;
typedef uint32 ESteamNetworkingFakeIPType;
...
void SteamAPI_ISteamClient_SetLocalIPBinding(intptr_t,const SteamIPAddress_t&,uint16);
...
int SteamAPI_ISteamUser_InitiateGameConnection_DEPRECATED(intptr_t,void*,int,uint64_steamid,uint32,uint16,bool);
void SteamAPI_ISteamUser_TerminateGameConnection_DEPRECATED(intptr_t,uint32,uint16);
...
EBeginAuthSessionResult SteamAPI_ISteamUser_BeginAuthSession(intptr_t,const void*,int,uint64_steamid);
...
bool SteamAPI_ISteamFriends_GetFriendGamePlayed(intptr_t,uint64_steamid,FriendGameInfo_t*);
...
bool SteamAPI_ISteamUtils_IsSteamRunningOnSteamDeck(intptr_t);
bool SteamAPI_ISteamUtils_ShowFloatingGamepadTextInput(intptr_t,EFloatingGamepadTextInputMode,int,int,int,int);
void SteamAPI_ISteamUtils_SetGameLauncherMode(intptr_t,bool);
bool SteamAPI_ISteamUtils_DismissFloatingGamepadTextInput(intptr_t);
...
bool SteamAPI_ISteamMatchmaking_SendLobbyChatMsg(intptr_t,uint64_steamid,const void*,int);
...
HServerListRequest SteamAPI_ISteamMatchmakingServers_RequestInternetServerList(intptr_t,AppId_t,struct MatchMakingKeyValuePair_t**ppchFilters,uint32,struct ISteamMatchmakingServerListResponse*);
...
HServerListRequest SteamAPI_ISteamMatchmakingServers_RequestFriendsServerList(intptr_t,AppId_t,struct MatchMakingKeyValuePair_t**ppchFilters,uint32,struct ISteamMatchmakingServerListResponse*);
HServerListRequest SteamAPI_ISteamMatchmakingServers_RequestFavoritesServerList(intptr_t,AppId_t,struct MatchMakingKeyValuePair_t**ppchFilters,uint32,struct ISteamMatchmakingServerListResponse*);
HServerListRequest SteamAPI_ISteamMatchmakingServers_RequestHistoryServerList(intptr_t,AppId_t,struct MatchMakingKeyValuePair_t**ppchFilters,uint32,struct ISteamMatchmakingServerListResponse*);
HServerListRequest SteamAPI_ISteamMatchmakingServers_RequestSpectatorServerList(intptr_t,AppId_t,struct MatchMakingKeyValuePair_t**ppchFilters,uint32,struct ISteamMatchmakingServerListResponse*);
...
intptr_t SteamAPI_SteamRemoteStorage_v016();
bool SteamAPI_ISteamRemoteStorage_FileWrite(intptr_t,const char*,const void*,int32);
int32 SteamAPI_ISteamRemoteStorage_FileRead(intptr_t,const char*,void*,int32);
SteamAPICall_t SteamAPI_ISteamRemoteStorage_FileWriteAsync(intptr_t,const char*,const void*,uint32);
...
bool SteamAPI_ISteamRemoteStorage_FileWriteStreamWriteChunk(intptr_t,UGCFileWriteStreamHandle_t,const void*,int32);
...
bool SteamAPI_ISteamRemoteStorage_GetUGCDetails(intptr_t,UGCHandle_t,AppId_t*,char**ppchName,int32*,struct CSteamID*);
...
SteamAPICall_t SteamAPI_ISteamRemoteStorage_PublishWorkshopFile(intptr_t,const char*,const char*,AppId_t,const char*,const char*,ERemoteStoragePublishedFileVisibility,SteamParamStringArray_t*,EWorkshopFileType);
...
bool SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTags(intptr_t,PublishedFileUpdateHandle_t,SteamParamStringArray_t*);
...
SteamAPICall_t SteamAPI_ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles(intptr_t,uint64_steamid,uint32,SteamParamStringArray_t*,SteamParamStringArray_t*);
SteamAPICall_t SteamAPI_ISteamRemoteStorage_PublishVideo(intptr_t,EWorkshopVideoProvider,const char*,const char*,const char*,AppId_t,const char*,const char*,ERemoteStoragePublishedFileVisibility,SteamParamStringArray_t*);
...
SteamAPICall_t SteamAPI_ISteamRemoteStorage_EnumeratePublishedWorkshopFiles(intptr_t,EWorkshopEnumerationType,uint32,uint32,uint32,SteamParamStringArray_t*,SteamParamStringArray_t*);
SteamAPICall_t SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation(intptr_t,UGCHandle_t,const char*,uint32);
int32 SteamAPI_ISteamRemoteStorage_GetLocalFileChangeCount(intptr_t);
const char*SteamAPI_ISteamRemoteStorage_GetLocalFileChange(intptr_t,int,ERemoteStorageLocalFileChange*,ERemoteStorageFilePathType*);
bool SteamAPI_ISteamRemoteStorage_BeginFileWriteBatch(intptr_t);
bool SteamAPI_ISteamRemoteStorage_EndFileWriteBatch(intptr_t);
...
bool SteamAPI_ISteamUserStats_GetDownloadedLeaderboardEntry(intptr_t,SteamLeaderboardEntries_t,int,LeaderboardEntry_t*,int32*,int);
...
bool SteamAPI_ISteamApps_BIsTimedTrial(intptr_t,uint32*,uint32*);

intptr_t SteamAPI_SteamNetworking_v006();
intptr_t SteamAPI_SteamGameServerNetworking_v006();
bool SteamAPI_ISteamNetworking_SendP2PPacket(intptr_t,uint64_steamid,const void*,uint32,EP2PSend,int);
...
bool SteamAPI_ISteamNetworking_GetP2PSessionState(intptr_t,uint64_steamid,P2PSessionState_t*);
bool SteamAPI_ISteamNetworking_AllowP2PPacketRelay(intptr_t,bool);
SNetListenSocket_t SteamAPI_ISteamNetworking_CreateListenSocket(intptr_t,int,SteamIPAddress_t,uint16,bool);
SNetSocket_t SteamAPI_ISteamNetworking_CreateP2PConnectionSocket(intptr_t,uint64_steamid,int,int,bool);
SNetSocket_t SteamAPI_ISteamNetworking_CreateConnectionSocket(intptr_t,SteamIPAddress_t,uint16,int);
...
bool SteamAPI_ISteamNetworking_GetSocketInfo(intptr_t,SNetSocket_t,struct CSteamID*,int*,SteamIPAddress_t*,uint16*);
bool SteamAPI_ISteamNetworking_GetListenSocketInfo(intptr_t,SNetListenSocket_t,SteamIPAddress_t*,uint16*);
...
intptr_t SteamAPI_SteamInput_v006();
bool SteamAPI_ISteamInput_Init(intptr_t,bool);
bool SteamAPI_ISteamInput_Shutdown(intptr_t);
bool SteamAPI_ISteamInput_SetInputActionManifestFilePath(intptr_t,const char*);
void SteamAPI_ISteamInput_RunFrame(intptr_t,bool);
bool SteamAPI_ISteamInput_BWaitForData(intptr_t,bool,uint32);
bool SteamAPI_ISteamInput_BNewDataAvailable(intptr_t);
int SteamAPI_ISteamInput_GetConnectedControllers(intptr_t,InputHandle_t*);
void SteamAPI_ISteamInput_EnableDeviceCallbacks(intptr_t);
//void SteamAPI_ISteamInput_EnableActionEventCallbacks(intptr_t,SteamInputActionEventCallbackPointer);
...
const char*SteamAPI_ISteamInput_GetStringForDigitalActionName(intptr_t,InputDigitalActionHandle_t);
...
const char*SteamAPI_ISteamInput_GetGlyphPNGForActionOrigin(intptr_t,EInputActionOrigin,ESteamInputGlyphSize,uint32);
const char*SteamAPI_ISteamInput_GetGlyphSVGForActionOrigin(intptr_t,EInputActionOrigin,uint32);
const char*SteamAPI_ISteamInput_GetGlyphForActionOrigin_Legacy(intptr_t,EInputActionOrigin);
const char*SteamAPI_ISteamInput_GetStringForActionOrigin(intptr_t,EInputActionOrigin);
const char*SteamAPI_ISteamInput_GetStringForAnalogActionName(intptr_t,InputAnalogActionHandle_t);
...
void SteamAPI_ISteamInput_TriggerVibrationExtended(intptr_t,InputHandle_t,unsigned short,unsigned short,unsigned short,unsigned short);
void SteamAPI_ISteamInput_TriggerSimpleHapticEvent(intptr_t,InputHandle_t,EControllerHapticLocation,uint8,char,uint8,char);
void SteamAPI_ISteamInput_SetLEDColor(intptr_t,InputHandle_t,uint8,uint8,uint8,unsigned int);
void SteamAPI_ISteamInput_Legacy_TriggerHapticPulse(intptr_t,InputHandle_t,ESteamControllerPad,unsigned short);
void SteamAPI_ISteamInput_Legacy_TriggerRepeatedHapticPulse(intptr_t,InputHandle_t,ESteamControllerPad,unsigned short,unsigned short,unsigned short,unsigned int);
...
uint16 SteamAPI_ISteamInput_GetSessionInputConfigurationSettings(intptr_t);
...
intptr_t SteamAPI_SteamUGC_v016();
intptr_t SteamAPI_SteamGameServerUGC_v016();
...
bool SteamAPI_ISteamUGC_GetQueryUGCResult(intptr_t,UGCQueryHandle_t,uint32,SteamUGCDetails_t*);
...
bool SteamAPI_ISteamUGC_AddRequiredTagGroup(intptr_t,UGCQueryHandle_t,const SteamParamStringArray_t*);
...
bool SteamAPI_ISteamUGC_SetTimeCreatedDateRange(intptr_t,UGCQueryHandle_t,RTime32,RTime32);
bool SteamAPI_ISteamUGC_SetTimeUpdatedDateRange(intptr_t,UGCQueryHandle_t,RTime32,RTime32);
...
bool SteamAPI_ISteamUGC_SetItemTags(intptr_t,UGCUpdateHandle_t,const SteamParamStringArray_t*);
...
bool SteamAPI_ISteamUGC_ShowWorkshopEULA(intptr_t);
SteamAPICall_t SteamAPI_ISteamUGC_GetWorkshopEULAStatus(intptr_t);
...
void SteamAPI_ISteamHTMLSurface_MouseUp(intptr_t,HHTMLBrowser,EHTMLMouseButton);
void SteamAPI_ISteamHTMLSurface_MouseDown(intptr_t,HHTMLBrowser,EHTMLMouseButton);
void SteamAPI_ISteamHTMLSurface_MouseDoubleClick(intptr_t,HHTMLBrowser,EHTMLMouseButton);
void SteamAPI_ISteamHTMLSurface_MouseMove(intptr_t,HHTMLBrowser,int x,int y);
void SteamAPI_ISteamHTMLSurface_MouseWheel(intptr_t,HHTMLBrowser,int32);
void SteamAPI_ISteamHTMLSurface_KeyDown(intptr_t,HHTMLBrowser,uint32,EHTMLKeyModifiers,bool);
void SteamAPI_ISteamHTMLSurface_KeyUp(intptr_t,HHTMLBrowser,uint32,EHTMLKeyModifiers);
void SteamAPI_ISteamHTMLSurface_KeyChar(intptr_t,HHTMLBrowser,uint32,EHTMLKeyModifiers);
...
void SteamAPI_ISteamHTMLSurface_GetLinkAtPosition(intptr_t,HHTMLBrowser,int x,int y);
...
void SteamAPI_ISteamHTMLSurface_FileLoadDialogResponse(intptr_t,HHTMLBrowser,const char**pchSelectedFiles);
...
bool SteamAPI_ISteamInventory_GetItemsByID(intptr_t,SteamInventoryResult_t*,const SteamItemInstanceID_t*,uint32);
bool SteamAPI_ISteamInventory_SerializeResult(intptr_t,SteamInventoryResult_t,void*,uint32*);
bool SteamAPI_ISteamInventory_DeserializeResult(intptr_t,SteamInventoryResult_t*,const void*,uint32,bool);
bool SteamAPI_ISteamInventory_GenerateItems(intptr_t,SteamInventoryResult_t*,const SteamItemDef_t*,const uint32*,uint32);
...
bool SteamAPI_ISteamInventory_AddPromoItems(intptr_t,SteamInventoryResult_t*,const SteamItemDef_t*,uint32);
bool SteamAPI_ISteamInventory_ConsumeItem(intptr_t,SteamInventoryResult_t*,SteamItemInstanceID_t,uint32);
bool SteamAPI_ISteamInventory_ExchangeItems(intptr_t,SteamInventoryResult_t*,const SteamItemDef_t*,const uint32*,uint32,const SteamItemInstanceID_t*,const uint32*,uint32);
...
bool SteamAPI_ISteamInventory_TradeItems(intptr_t,SteamInventoryResult_t*,uint64_steamid,const SteamItemInstanceID_t*,const uint32*,uint32,const SteamItemInstanceID_t*,const uint32*,uint32);
...
SteamAPICall_t SteamAPI_ISteamInventory_StartPurchase(intptr_t,const SteamItemDef_t*,const uint32*,uint32);
...
bool SteamAPI_ISteamInventory_InspectItem(intptr_t,SteamInventoryResult_t*,const char*);
...
RemotePlaySessionID_t SteamAPI_ISteamRemotePlay_GetSessionID(intptr_t,int);
uint64_steamid SteamAPI_ISteamRemotePlay_GetSessionSteamID(intptr_t,RemotePlaySessionID_t);
const char*SteamAPI_ISteamRemotePlay_GetSessionClientName(intptr_t,RemotePlaySessionID_t);
ESteamDeviceFormFactor SteamAPI_ISteamRemotePlay_GetSessionClientFormFactor(intptr_t,RemotePlaySessionID_t);
bool SteamAPI_ISteamRemotePlay_BGetSessionClientResolution(intptr_t,RemotePlaySessionID_t,int*,int*);
bool SteamAPI_ISteamRemotePlay_BSendRemotePlayTogetherInvite(intptr_t,uint64_steamid);

intptr_t SteamAPI_SteamNetworkingMessages_SteamAPI_v002();
intptr_t SteamAPI_SteamGameServerNetworkingMessages_SteamAPI_v002();
EResult SteamAPI_ISteamNetworkingMessages_SendMessageToUser(intptr_t,const struct SteamNetworkingIdentity&,const void*,uint32,int,int);
int SteamAPI_ISteamNetworkingMessages_ReceiveMessagesOnChannel(intptr_t,int,struct SteamNetworkingMessage_t**ppOutMessages,int);
bool SteamAPI_ISteamNetworkingMessages_AcceptSessionWithUser(intptr_t,const struct SteamNetworkingIdentity&);
bool SteamAPI_ISteamNetworkingMessages_CloseSessionWithUser(intptr_t,const struct SteamNetworkingIdentity&);
bool SteamAPI_ISteamNetworkingMessages_CloseChannelWithUser(intptr_t,const struct SteamNetworkingIdentity&,int);
ESteamNetworkingConnectionState SteamAPI_ISteamNetworkingMessages_GetSessionConnectionInfo(intptr_t,const struct SteamNetworkingIdentity&,struct SteamNetConnectionInfo_t*,struct SteamNetConnectionRealTimeStatus_t*);

intptr_t SteamAPI_SteamNetworkingSockets_SteamAPI_v012();
intptr_t SteamAPI_SteamGameServerNetworkingSockets_SteamAPI_v012();
...
bool SteamAPI_ISteamNetworkingSockets_CloseListenSocket(intptr_t,HSteamListenSocket);
...
EResult SteamAPI_ISteamNetworkingSockets_SendMessageToConnection(intptr_t,HSteamNetConnection,const void*,uint32,int,int64*);
...
int SteamAPI_ISteamNetworkingSockets_ReceiveMessagesOnConnection(intptr_t,HSteamNetConnection,struct SteamNetworkingMessage_t**ppOutMessages,int);
bool SteamAPI_ISteamNetworkingSockets_GetConnectionInfo(intptr_t,HSteamNetConnection,struct SteamNetConnectionInfo_t*);
EResult SteamAPI_ISteamNetworkingSockets_GetConnectionRealTimeStatus(intptr_t,HSteamNetConnection,struct SteamNetConnectionRealTimeStatus_t*,int,struct SteamNetConnectionRealTimeLaneStatus_t*);
int SteamAPI_ISteamNetworkingSockets_GetDetailedConnectionStatus(intptr_t,HSteamNetConnection,char*,int);
bool SteamAPI_ISteamNetworkingSockets_GetListenSocketAddress(intptr_t,HSteamListenSocket,struct SteamNetworkingIPAddr*);
...
EResult SteamAPI_ISteamNetworkingSockets_ConfigureConnectionLanes(intptr_t,HSteamNetConnection,int,const int*,const uint16*);
...
int SteamAPI_ISteamNetworkingSockets_ReceiveMessagesOnPollGroup(intptr_t,HSteamNetPollGroup,struct SteamNetworkingMessage_t**ppOutMessages,int);
...
HSteamNetConnection SteamAPI_ISteamNetworkingSockets_ConnectP2PCustomSignaling(intptr_t,intptr_t,const struct SteamNetworkingIdentity*,int,int,const struct SteamNetworkingConfigValue_t*);
bool SteamAPI_ISteamNetworkingSockets_ReceivedP2PCustomSignal(intptr_t,const void*,int,intptr_t);
bool SteamAPI_ISteamNetworkingSockets_GetCertificateRequest(intptr_t,int*,void*,struct SteamNetworkingErrMsg&);
bool SteamAPI_ISteamNetworkingSockets_SetCertificate(intptr_t,const void*,int,struct SteamNetworkingErrMsg&);
void SteamAPI_ISteamNetworkingSockets_ResetIdentity(intptr_t,const struct SteamNetworkingIdentity*);
void SteamAPI_ISteamNetworkingSockets_RunCallbacks(intptr_t);
bool SteamAPI_ISteamNetworkingSockets_BeginAsyncRequestFakeIP(intptr_t,int);
void SteamAPI_ISteamNetworkingSockets_GetFakeIP(intptr_t,int,struct SteamNetworkingFakeIPResult_t*);
HSteamListenSocket SteamAPI_ISteamNetworkingSockets_CreateListenSocketP2PFakeIP(intptr_t,int,int,const struct SteamNetworkingConfigValue_t*);
EResult SteamAPI_ISteamNetworkingSockets_GetRemoteFakeIPForConnection(intptr_t,HSteamNetConnection,struct SteamNetworkingIPAddr*);
struct ISteamNetworkingFakeUDPPort*SteamAPI_ISteamNetworkingSockets_CreateFakeUDPPort(intptr_t,int);

intptr_t SteamAPI_SteamNetworkingUtils_SteamAPI_v004();
...
int SteamAPI_ISteamNetworkingUtils_EstimatePingTimeBetweenTwoLocations(intptr_t,const struct SteamNetworkPingLocation_t&,const struct SteamNetworkPingLocation_t&);
int SteamAPI_ISteamNetworkingUtils_EstimatePingTimeFromLocalHost(intptr_t,const struct SteamNetworkPingLocation_t&);
void SteamAPI_ISteamNetworkingUtils_ConvertPingLocationToString(intptr_t,const struct SteamNetworkPingLocation_t&,char*,int);
...
bool SteamAPI_ISteamNetworkingUtils_IsFakeIPv4(intptr_t,uint32);
ESteamNetworkingFakeIPType SteamAPI_ISteamNetworkingUtils_GetIPv4FakeIPType(intptr_t,uint32);
EResult SteamAPI_ISteamNetworkingUtils_GetRealIdentityForFakeIP(intptr_t,const struct SteamNetworkingIPAddr&,struct SteamNetworkingIdentity*);
...
bool SteamAPI_ISteamNetworkingUtils_SetGlobalConfigValuePtr(intptr_t,ESteamNetworkingConfigValue,void*);
...
// bool SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamNetConnectionStatusChanged(intptr_t,FnSteamNetConnectionStatusChanged);
// bool SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamNetAuthenticationStatusChanged(intptr_t,FnSteamNetAuthenticationStatusChanged);
// bool SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_SteamRelayNetworkStatusChanged(intptr_t,FnSteamRelayNetworkStatusChanged);
// bool SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_FakeIPResult(intptr_t,FnSteamNetworkingFakeIPResult);
// bool SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_MessagesSessionRequest(intptr_t,FnSteamNetworkingMessagesSessionRequest);
// bool SteamAPI_ISteamNetworkingUtils_SetGlobalCallback_MessagesSessionFailed(intptr_t,FnSteamNetworkingMessagesSessionFailed);
bool SteamAPI_ISteamNetworkingUtils_SetConfigValue(intptr_t,ESteamNetworkingConfigValue,ESteamNetworkingConfigScope,intptr_t,ESteamNetworkingConfigDataType,const void*);
bool SteamAPI_ISteamNetworkingUtils_SetConfigValueStruct(intptr_t,const struct SteamNetworkingConfigValue_t&,ESteamNetworkingConfigScope,intptr_t);
...
const char*SteamAPI_ISteamNetworkingUtils_GetConfigValueInfo(intptr_t,ESteamNetworkingConfigValue,ESteamNetworkingConfigDataType*,ESteamNetworkingConfigScope*);
ESteamNetworkingConfigValue SteamAPI_ISteamNetworkingUtils_IterateGenericEditableConfigValues(intptr_t,ESteamNetworkingConfigValue,bool);
void SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_ToString(intptr_t,const struct SteamNetworkingIPAddr&,char*,uint32,bool);
bool SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_ParseString(intptr_t,struct SteamNetworkingIPAddr*,const char*);
ESteamNetworkingFakeIPType SteamAPI_ISteamNetworkingUtils_SteamNetworkingIPAddr_GetFakeIPType(intptr_t,const struct SteamNetworkingIPAddr&);
void SteamAPI_ISteamNetworkingUtils_SteamNetworkingIdentity_ToString(intptr_t,const struct SteamNetworkingIdentity&,char*,uint32);
bool SteamAPI_ISteamNetworkingUtils_SteamNetworkingIdentity_ParseString(intptr_t,struct SteamNetworkingIdentity*,const char*);

intptr_t SteamAPI_SteamGameServer_v014();
...
void SteamAPI_ISteamGameServer_SetAdvertiseServerActive(intptr_t,bool);
HAuthTicket SteamAPI_ISteamGameServer_GetAuthSessionTicket(intptr_t,void*,int,uint32*);
EBeginAuthSessionResult SteamAPI_ISteamGameServer_BeginAuthSession(intptr_t,const void*,int,uint64_steamid);
...
SteamIPAddress_t SteamAPI_ISteamGameServer_GetPublicIP(intptr_t);
bool SteamAPI_ISteamGameServer_HandleIncomingPacket(intptr_t,const void*,int,uint32,uint16);
...
bool SteamAPI_ISteamGameServer_SendUserConnectAndAuthenticate_DEPRECATED(intptr_t,uint32,const void*,uint32,struct CSteamID*);
uint64_steamid SteamAPI_ISteamGameServer_CreateUnauthenticatedUserConnection(intptr_t);
void SteamAPI_ISteamGameServer_SendUserDisconnect_DEPRECATED(intptr_t,uint64_steamid);
...
void SteamAPI_ISteamNetworkingFakeUDPPort_DestroyFakeUDPPort(struct ISteamNetworkingFakeUDPPort*);
EResult SteamAPI_ISteamNetworkingFakeUDPPort_SendMessageToFakeIP(struct ISteamNetworkingFakeUDPPort*,const struct SteamNetworkingIPAddr&,const void*,uint32,int);
int SteamAPI_ISteamNetworkingFakeUDPPort_ReceiveMessages(struct ISteamNetworkingFakeUDPPort*,struct SteamNetworkingMessage_t**ppOutMessages,int);
void SteamAPI_ISteamNetworkingFakeUDPPort_ScheduleCleanup(struct ISteamNetworkingFakeUDPPort*,const struct SteamNetworkingIPAddr&);

bool SteamAPI_SteamIPAddress_t_IsSet(SteamIPAddress_t*);
...
void SteamAPI_servernetadr_t_Init(struct servernetadr_t*,unsigned int,uint16,uint16);
...
bool SteamAPI_servernetadr_t_IsLessThan(struct servernetadr_t*,const struct servernetadr_t&);
void SteamAPI_servernetadr_t_Assign(struct servernetadr_t*,const struct servernetadr_t&);
...
void SteamAPI_SteamNetworkingIPAddr_Clear(struct SteamNetworkingIPAddr*);
bool SteamAPI_SteamNetworkingIPAddr_IsIPv6AllZeros(struct SteamNetworkingIPAddr*);
void SteamAPI_SteamNetworkingIPAddr_SetIPv6(struct SteamNetworkingIPAddr*,const uint8*,uint16);
void SteamAPI_SteamNetworkingIPAddr_SetIPv4(struct SteamNetworkingIPAddr*,uint32,uint16);
bool SteamAPI_SteamNetworkingIPAddr_IsIPv4(struct SteamNetworkingIPAddr*);
uint32 SteamAPI_SteamNetworkingIPAddr_GetIPv4(struct SteamNetworkingIPAddr*);
void SteamAPI_SteamNetworkingIPAddr_SetIPv6LocalHost(struct SteamNetworkingIPAddr*,uint16);
bool SteamAPI_SteamNetworkingIPAddr_IsLocalHost(struct SteamNetworkingIPAddr*);
void SteamAPI_SteamNetworkingIPAddr_ToString(struct SteamNetworkingIPAddr*,char*,uint32,bool);
bool SteamAPI_SteamNetworkingIPAddr_ParseString(struct SteamNetworkingIPAddr*,const char*);
bool SteamAPI_SteamNetworkingIPAddr_IsEqualTo(struct SteamNetworkingIPAddr*,const struct SteamNetworkingIPAddr&x);
ESteamNetworkingFakeIPType SteamAPI_SteamNetworkingIPAddr_GetFakeIPType(struct SteamNetworkingIPAddr*);
bool SteamAPI_SteamNetworkingIPAddr_IsFakeIP(struct SteamNetworkingIPAddr*);

void SteamAPI_SteamNetworkingIdentity_Clear(struct SteamNetworkingIdentity*);
bool SteamAPI_SteamNetworkingIdentity_IsInvalid(struct SteamNetworkingIdentity*);
void SteamAPI_SteamNetworkingIdentity_SetSteamID(struct SteamNetworkingIdentity*,uint64_steamid);
uint64_steamid SteamAPI_SteamNetworkingIdentity_GetSteamID(struct SteamNetworkingIdentity*);
void SteamAPI_SteamNetworkingIdentity_SetSteamID64(struct SteamNetworkingIdentity*,uint64);
uint64 SteamAPI_SteamNetworkingIdentity_GetSteamID64(struct SteamNetworkingIdentity*);
bool SteamAPI_SteamNetworkingIdentity_SetXboxPairwiseID(struct SteamNetworkingIdentity*,const char*);
const char*SteamAPI_SteamNetworkingIdentity_GetXboxPairwiseID(struct SteamNetworkingIdentity*);
void SteamAPI_SteamNetworkingIdentity_SetPSNID(struct SteamNetworkingIdentity*,uint64);
uint64 SteamAPI_SteamNetworkingIdentity_GetPSNID(struct SteamNetworkingIdentity*);
void SteamAPI_SteamNetworkingIdentity_SetStadiaID(struct SteamNetworkingIdentity*,uint64);
uint64 SteamAPI_SteamNetworkingIdentity_GetStadiaID(struct SteamNetworkingIdentity*);
void SteamAPI_SteamNetworkingIdentity_SetIPAddr(struct SteamNetworkingIdentity*,const struct SteamNetworkingIPAddr&);
const struct SteamNetworkingIPAddr*SteamAPI_SteamNetworkingIdentity_GetIPAddr(struct SteamNetworkingIdentity*);
void SteamAPI_SteamNetworkingIdentity_SetIPv4Addr(struct SteamNetworkingIdentity*,uint32,uint16);
uint32 SteamAPI_SteamNetworkingIdentity_GetIPv4(struct SteamNetworkingIdentity*);
ESteamNetworkingFakeIPType SteamAPI_SteamNetworkingIdentity_GetFakeIPType(struct SteamNetworkingIdentity*);
bool SteamAPI_SteamNetworkingIdentity_IsFakeIP(struct SteamNetworkingIdentity*);
void SteamAPI_SteamNetworkingIdentity_SetLocalHost(struct SteamNetworkingIdentity*);
bool SteamAPI_SteamNetworkingIdentity_IsLocalHost(struct SteamNetworkingIdentity*);
bool SteamAPI_SteamNetworkingIdentity_SetGenericString(struct SteamNetworkingIdentity*,const char*);
const char*SteamAPI_SteamNetworkingIdentity_GetGenericString(struct SteamNetworkingIdentity*);
bool SteamAPI_SteamNetworkingIdentity_SetGenericBytes(struct SteamNetworkingIdentity*,const void*,uint32);
const uint8*SteamAPI_SteamNetworkingIdentity_GetGenericBytes(struct SteamNetworkingIdentity*,int&);
bool SteamAPI_SteamNetworkingIdentity_IsEqualTo(struct SteamNetworkingIdentity*,const struct SteamNetworkingIdentity&);
void SteamAPI_SteamNetworkingIdentity_ToString(struct SteamNetworkingIdentity*,char*,uint32);
bool SteamAPI_SteamNetworkingIdentity_ParseString(struct SteamNetworkingIdentity*,const char*);

void SteamAPI_SteamNetworkingMessage_t_Release(struct SteamNetworkingMessage_t*);

void SteamAPI_SteamNetworkingConfigValue_t_SetInt32(struct SteamNetworkingConfigValue_t*,ESteamNetworkingConfigValue,int32_t);
void SteamAPI_SteamNetworkingConfigValue_t_SetInt64(struct SteamNetworkingConfigValue_t*,ESteamNetworkingConfigValue,int64_t);
void SteamAPI_SteamNetworkingConfigValue_t_SetFloat(struct SteamNetworkingConfigValue_t*,ESteamNetworkingConfigValue,float);
void SteamAPI_SteamNetworkingConfigValue_t_SetPtr(struct SteamNetworkingConfigValue_t*,ESteamNetworkingConfigValue,void*);
void SteamAPI_SteamNetworkingConfigValue_t_SetString(struct SteamNetworkingConfigValue_t*,ESteamNetworkingConfigValue,const char*);

void SteamAPI_SteamDatagramHostedAddress_Clear(struct SteamDatagramHostedAddress*);
SteamNetworkingPOPID SteamAPI_SteamDatagramHostedAddress_GetPopID(struct SteamDatagramHostedAddress*);
void SteamAPI_SteamDatagramHostedAddress_SetDevAddress(struct SteamDatagramHostedAddress*,uint32,uint16,SteamNetworkingPOPID);
